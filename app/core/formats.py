...
EXTENSION_CATEGORIES: dict[str, str] = {
    ...
    ".jsonl": MEDIA_CATEGORY_TEXT,
    ".xml": MEDIA_CATEGORY_TEXT,
    ".rss": MEDIA_CATEGORY_TEXT,
    ".atom": MEDIA_CATEGORY_TEXT,
    ".yaml": MEDIA_CATEGORY_TEXT,
    ".yml": MEDIA_CATEGORY_TEXT,
    ".log": MEDIA_CATEGORY_TEXT,
    ".syslog": MEDIA_CATEGORY_TEXT,
    ".yara": MEDIA_CATEGORY_TEXT,
    ".sigma": MEDIA_CATEGORY_TEXT,
    ".py": MEDIA_CATEGORY_TEXT,
    ".sh": MEDIA_CATEGORY_TEXT,
    ".ps1": MEDIA_CATEGORY_TEXT,
    ".stix": MEDIA_CATEGORY_TEXT,
    ".taxii": MEDIA_CATEGORY_TEXT,
...
MIME_CATEGORIES: dict[str, str] = {
    ...
    "text/tab-separated-values": MEDIA_CATEGORY_TEXT,
    "text/html": MEDIA_CATEGORY_TEXT,
    "text/xml": MEDIA_CATEGORY_TEXT,
    "text/yaml": MEDIA_CATEGORY_TEXT,
    "application/yaml": MEDIA_CATEGORY_TEXT,
    "text/x-python": MEDIA_CATEGORY_TEXT,
    "text/x-sh": MEDIA_CATEGORY_TEXT,
    "application/x-sh": MEDIA_CATEGORY_TEXT,
    "application/powershell": MEDIA_CATEGORY_TEXT,
    "text/rtf": MEDIA_CATEGORY_DOCUMENT,
    "application/json": MEDIA_CATEGORY_TEXT,
    "application/x-ndjson": MEDIA_CATEGORY_TEXT,
    "application/ndjson": MEDIA_CATEGORY_TEXT,
    "application/xml": MEDIA_CATEGORY_TEXT,
    "application/rss+xml": MEDIA_CATEGORY_TEXT,
    "application/atom+xml": MEDIA_CATEGORY_TEXT,
    ...
    "image/x-ms-bmp": MEDIA_CATEGORY_IMAGE,
    ...
    "application/ogg": MEDIA_CATEGORY_AUDIO,
